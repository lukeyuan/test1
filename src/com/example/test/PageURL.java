...
public class PageURL {
	...
	public static String URL_OLD3 = "183.63.86.154:9999/ISC/services/ISC";
	public static String URL = "https://192.168.32.100:8443/jaxwsServer/HelloJaxwsPort?wsdl";
	public static String URL2 = "http://192.168.32.100:8080/jaxwsServer/HelloJaxwsPort?wsdl";
...
//	public static String para="{datetime:\""+"2013-03-06 21:13:21"+"\",user:\""+"75"+"\",app:\"andriod++app\",operate:\"login\",sign:\""+"5cc222e839acc9ec4630baa0a71d0d70425abe80a0e1d418019ae4bbea2b726b"+"\"}";
	...
	public static JSONObject getPara(String mUser,String operate,String mode,String mMD5Password){
		...
		String sign=new Hmac().signature(mMD5Password, ""+datetime+mUser+PageURL.APP+operate+mode);
		
		JSONObject para=new JSONObject();
		try {
			para.put("datetime", datetime);
			para.put("user", mUser);
			para.put("app", PageURL.APP);
	...
	public static JSONObject getPara(String mUser,String operate,String mode,String mMD5Password,String params){
		...
		String sign=new Hmac().signature(mMD5Password, ""+datetime+mUser+PageURL.APP+operate+mode+params);
	...
	public static JSONObject connect(SSLSocketFactory sslSocketFactory, JSONObject para, String METHOD_NAME){

		try {
			
			System.out.println("rpc------");
			SoapObject rpc = new SoapObject(PageURL.NAMESPACE, METHOD_NAME);
			rpc.addProperty("parameters", para.toString());
			System.out.println("rpc" +  rpc.toString());
			SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
			envelope.bodyOut = rpc;
			envelope.dotNet = false;
			HttpsTransportSE ht = new HttpsTransportSE(PageURL.URL, PageURL.TIMEOUT, METHOD_NAME, TIMEOUT);
			((HttpsServiceConnectionSE)ht.getServiceConnection()).setSSLSocketFactory(sslSocketFactory);
			ht.debug = true;
	...
	public static JSONObject connect_(SSLSocketFactory client, JSONObject para, String METHOD_NAME){
		...
		try {
			...
			//rpc.addProperty("parameters", para.toString());
			rpc.addProperty("userName", "aaa");
			System.out.println("rpc" +  rpc.toString());
			SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
			envelope.bodyOut = rpc;
			envelope.dotNet = false;
			HttpTransportSE ht = new HttpTransportSE(PageURL.URL, TIMEOUT);
			((HttpsServiceConnectionSE)ht.getServiceConnection()).setSSLSocketFactory((client));
			ht.debug = true;
			ht.call("", envelope);
			SoapPrimitive sp=(SoapPrimitive)envelope.getResponse();
			System.out.println(""+sp.toString());
